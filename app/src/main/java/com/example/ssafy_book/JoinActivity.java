            ...
            case R.id.join_btn:
                ...
                if(pwCheck){
                    ...
                    try {
                        ...
                        PersonalUnlockAccount personalUnlockAccount = admin.personalUnlockAccount("0xf2f28e374e0b0082cea1177a43d54ec516f33e21","test1").sendAsync().get();

                        String message = "";

                        BigInteger amount = BigInteger.valueOf(20).multiply(BigInteger.valueOf(10).pow(18));
                        Transaction transaction = Transaction.createFunctionCallTransaction("0xf2f28e374e0b0082cea1177a43d54ec516f33e21",null,BigInteger.ONE,BigInteger.valueOf(21000),ethId,amount,message);
                    ...
                    reqTask.execute("http://163.239.200.201:8080","api/membership/join", "POST", gson.toJson(params));
