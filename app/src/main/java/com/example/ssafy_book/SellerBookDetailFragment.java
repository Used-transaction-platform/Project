...
public class SellerBookDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        reqTask.execute("http://163.239.200.201:8080",boardURL, "GET");
...
//            String buyerAccountResult = String.valueOf("구매자 : " + resBoardSubmitParam.getBoard().getBuyer());
            ...
            //운송장 번호 등록
            sellerBtn.setText("배송 등록");
            sellerBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                     try {
                         sellerBtn.setText("배송정보 등록중.....");
                        ...
                        Escrow escrow = Escrow.load(resBoardSubmitParam.getBoard().getContract_id(),web3j,credentials,new DefaultGasProvider());
            ...
            //정상거래 버튼삭제
            sellerBtn.setVisibility(View.INVISIBLE);
        }else if(boardState == 5){
            //신고 - 소명자료 연락처 기입
            sellerBtn.setText("e-mail : admin@junggo.com 으로 소명자료를 보내 주세요");
